...
backups-empty-title = No hay copias de seguridad
backups-empty-description = Comienza creando un nuevo servidor de respaldo.
backups-table-header-created = Creado
backups-view = Ver
...
backups-back-to-backups = Volver a Copias de Seguridad
...
backups-add-title = Agregar Copia de Seguridad
backups-edit-title = Editar Copia de Seguridad
...
aliases-mail-address = Dirección de Correo
...
aliases-tooltip-mail = La dirección de correo electrónico para el alias (ej., alias@ejemplo.com)
aliases-tooltip-destination = La dirección de correo electrónico de destino donde se reenviará el correo
aliases-tooltip-domain = El dominio para este alias (debe coincidir con un dominio existente)
aliases-active = Activo
aliases-tooltip-active = Habilitar este alias para el reenvío de correo
aliases-cancel = Cancelar
aliases-update-alias = Actualizar Alias
aliases-create-alias = Crear Alias
...
users-table-header-user-id = ID de Usuario
users-table-header-name = Nombre
users-view = Ver
users-enable = Habilitar
users-disable = Deshabilitar
users-empty-no-users = No hay usuarios
users-empty-get-started = Comienza creando un nuevo usuario.
...
users-full-name = Nombre Completo
users-status = Estado
...
users-placeholder-name = Juan Pérez
...
users-tooltip-name = El nombre de visualización para el usuario (ej. Juan Pérez)
users-tooltip-active = Habilitar esta cuenta de usuario
users-cancel = Cancelar
users-create-user = Crear Usuario
users-update-user = Actualizar Usuario
...
config-required-aliases-description = "Estos alias son esenciales para el cumplimiento de estándares de correo electrónico (requisitos RFC)."
config-common-aliases-description = "Estos alias son comúnmente esperados por usuarios y servicios pero no estrictamente requeridos."
...
config-add-alias-button = "Agregar Alias"
config-placeholder-required-alias = "Ingrese nuevo alias requerido (ej., postmaster)"
...
# Relays
relays-title = Relés
relays-description = Gestionar destinatarios de relé y su estado para la configuración de Postfix.
...
relays-table-header-modified = Modificado
...
relays-back-to-relays = Volver a Relés
...
relays-action-edit = Editar
relays-action-enable = Habilitar
relays-action-disable = Deshabilitar
relays-action-delete = Eliminar
relays-action-view = Ver
relays-action-toggle = Alternar
...
relays-action-cancel = Cancelar
relays-action-save = Guardar

# Relocated
relocated-title = Reubicados
relocated-description = Gestionar reubicaciones de direcciones de correo para la configuración de Postfix.
...
relocated-table-header-modified = Modificado
...
relocated-show-title-label = Reubicado
...
relocated-action-edit = Editar
relocated-action-enable = Habilitar
relocated-action-disable = Deshabilitar
relocated-action-delete = Eliminar
relocated-action-view = Ver
relocated-action-toggle = Alternar
...
relocated-action-cancel = Cancelar
relocated-action-save = Guardar
