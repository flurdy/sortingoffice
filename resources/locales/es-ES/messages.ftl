...
domains-delete-disabled-tooltip = Debe desactivar el dominio antes de poder eliminarlo.
domains-convert-to-backup = Convertir a dominio de respaldo
domains-convert-to-backup-confirm = ¿Está seguro de que desea convertir este dominio en un dominio de respaldo?
domains-convert-error = Error al convertir el dominio
domains-not-found = Dominio no encontrado
domains-not-found-title = Dominio no encontrado
domains-not-found-message = El dominio que busca no se pudo encontrar.
...
backups-delete-disabled-tooltip = Debe desactivar la copia de seguridad antes de poder eliminarla.
backups-convert-to-domain = Convertir a dominio principal
backups-convert-to-domain-confirm = ¿Está seguro de que desea convertir este dominio de respaldo en un dominio principal?
backups-convert-error = Error al convertir el dominio de respaldo
backups-not-found = Dominio de respaldo no encontrado
backups-not-found-title = Dominio de respaldo no encontrado
backups-not-found-message = El dominio de respaldo que busca no se pudo encontrar.
...
aliases-delete-disabled-tooltip = Debe desactivar el alias antes de poder eliminarlo.
aliases-not-found = Alias no encontrado
aliases-not-found-title = Alias no encontrado
aliases-not-found-message = El alias que busca no se pudo encontrar.
...
users-delete-disabled-tooltip = Debe desactivar el usuario antes de poder eliminarlo.
...
stats-table-header-relocated = Reubicados
...
relays-enable = Activar Relé
relays-disable = Desactivar Relé
relays-update-relay = Actualizar Relé

# Remove Domain Wizard
remove-wizard-title = Asistente para Eliminar Dominio
remove-wizard-description = Eliminar permanentemente un dominio y todos los recursos asociados
remove-wizard-domain-label = Seleccionar Dominio a Eliminar
remove-wizard-domain-placeholder = Elegir un dominio...
remove-wizard-domain-description = Seleccione el dominio que desea eliminar permanentemente de esta base de datos
remove-wizard-warning = Este asistente primero desactivará todos los recursos y luego los eliminará permanentemente. Esta acción no se puede deshacer.
remove-wizard-next = Continuar
remove-wizard-cancel = Cancelar
remove-wizard-review-affected-title = Revisar Recursos Afectados
remove-wizard-review-affected-description = Revisar todos los recursos que serán desactivados y eliminados
remove-wizard-affected-resources = Recursos que serán afectados
remove-wizard-orphaned-warning = Aliases que quedarán huérfanos
remove-wizard-cross-db-warning = Este dominio existe en otras bases de datos
remove-wizard-disable-all = Desactivar Todos los Recursos
remove-wizard-review-disabled-title = Recursos Desactivados
remove-wizard-review-disabled-description = Todos los recursos han sido desactivados. Ahora puede proceder a la eliminación o cancelar.
remove-wizard-proceed-to-delete = Proceder a la Eliminación
remove-wizard-confirm-delete-title = Confirmar Eliminación
remove-wizard-confirm-delete-description = Confirmación final antes de la eliminación permanente
remove-wizard-warning-final = ⚠️ ADVERTENCIA: ¡Esta acción no se puede deshacer!
remove-wizard-resources-to-delete = Recursos a eliminar permanentemente
remove-wizard-orphaned-reminder = Los aliases huérfanos NO serán eliminados
remove-wizard-delete-all = ELIMINAR TODOS LOS RECURSOS
remove-wizard-complete-title = Dominio Eliminado Exitosamente
remove-wizard-complete-description = El dominio y todos los recursos asociados han sido eliminados permanentemente
remove-wizard-success = Dominio eliminado exitosamente
remove-wizard-deleted-resources = Recursos Eliminados
remove-wizard-cross-db-note = Este dominio todavía existe en otras bases de datos
remove-wizard-back-to-domains = Volver a Dominios
remove-wizard-remove-another = Eliminar Otro Dominio
remove-wizard-resource-domain = Dominio
remove-wizard-resource-aliases = Aliases
remove-wizard-resource-users = Usuarios
remove-wizard-resource-relays = Relés
remove-wizard-resource-relocated = Reubicados
...
relays-delete-disabled-tooltip = Debe desactivar el relé antes de poder eliminarlo.
...
relocated-delete-disabled-tooltip = Debe desactivar la dirección reubicada antes de poder eliminarla.
...
relocated-not-found-title = Dirección reubicada no encontrada
relocated-not-found-message = La dirección reubicada que busca no se pudo encontrar.
...
clients-delete-disabled-tooltip = Debe desactivar el cliente antes de poder eliminarlo.
clients-not-found = Cliente no encontrado
clients-not-found-title = Cliente no encontrado
clients-not-found-message = El cliente que busca no se pudo encontrar.
...
relays-not-found = Relay no encontrado
relays-not-found-title = Relay no encontrado
relays-not-found-message = El relay que busca no se pudo encontrar.
...
reports-hide-disabled = Ocultar Recursos Deshabilitados
reports-show-disabled = Mostrar Todos los Recursos
...
users-not-found = Usuario no encontrado
users-not-found-title = Usuario no encontrado
users-not-found-message = El usuario que busca no se pudo encontrar.
...
# MX Servers Report
reports-mx-servers-title = Informe de Servidores MX
reports-mx-servers-description = Verificar si los registros MX de los dominios apuntan a los servidores de correo configurados
reports-mx-status-header = Estado MX
reports-mx-records-header = Registros MX
reports-missing-servers-header = Servidores Faltantes
reports-unexpected-servers-header = Servidores Inesperados
reports-mx-status-compliant = Conforme
reports-mx-status-non-compliant = No Conforme
reports-mx-status-empty = Sin Registros MX
reports-mx-status-error = Error DNS
reports-configured-mail-servers = Servidores de Correo Configurados
reports-summary-title = Resumen
reports-total-domains = Total de Dominios
reports-compliant-domains = Conformes
reports-non-compliant-domains = No Conformes
reports-empty-mx-domains = Sin Registros MX
reports-error-domains = Errores DNS
reports-filters = Filtros
reports-exclude-disabled = Excluir Dominios Deshabilitados
