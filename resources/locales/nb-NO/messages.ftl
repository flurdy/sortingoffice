...
contact-response-times = Svarstider
contact-response-times-desc = Forventede svarstider for ulike typer henvendelser
contact-bug-reports = Feilrapporter
contact-feature-requests = Funksjonsforespørsler
contact-general-questions = Generelle spørsmål
contact-security-issues = Sikkerhetsproblemer
contact-enterprise-support = Enterprise-støtte
...
aliases-destination = Destinasjon
...
users-form-password = Passord
users-form-active = Aktiv
users-placeholder-user-email = bruker@eksempel.no
users-placeholder-name = brukernavn
users-tooltip-user-id = E-postadressen for brukerkontoen (f.eks. bruker@eksempel.no)
users-tooltip-password = Passordet for brukerkontoen (la stå tomt for å beholde eksisterende passord ved redigering)
users-tooltip-name = Brukernavnet for brukerkontoen
users-tooltip-active = Aktiver denne brukerkontoen
users-cancel = Avbryt
users-create-user = Opprett bruker
users-update-user = Oppdater bruker
...
users-tooltip-maildir = Navnet på brukerens postboksmappe
users-placeholder-maildir = f.eks. bruker
users-home = Hjemmekatalog
users-tooltip-home = Rotmappen som inneholder postbokser
...
config-required-aliases-header = "Påkrevde aliaser"
config-common-aliases-header = "Vanlige aliaser"
config-domain-overrides-header = "Domene overstyringer"
config-save-button = "Lagre konfigurasjon"
config-cancel-button = "Avbryt"
config-add-required-alias-button = "Legg til påkrevd alias"
config-add-common-alias-button = "Legg til vanlig alias"
config-remove-alias-button = "Fjern"
config-promote-button = "Fremme til påkrevd"
config-demote-button = "Degrader til vanlig"
config-required-aliases-description = "Disse aliasene er essensielle for e-poststandarder (RFC-krav)."
config-common-aliases-description = "Disse aliasene er vanligvis forventet av brukere og tjenester, men ikke strengt påkrevd."
...
config-add-alias-button = "Legg til alias"
config-placeholder-required-alias = "Skriv inn nytt påkrevd alias (f.eks. postmaster)"
config-placeholder-common-alias = "Skriv inn nytt vanlig alias (f.eks. admin)"
