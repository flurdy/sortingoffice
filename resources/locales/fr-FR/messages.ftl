...
nav-wizard = Ajouter des Domaines en Masse
nav-duplicate-wizard = Dupliquer le Domaine
nav-remove-wizard = Supprimer le Domaine
nav-about = À Propos
nav-contact = Contact
...
pagination-status-filter = Statut
