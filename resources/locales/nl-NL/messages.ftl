...
dns-lookup-button = DNS opzoeken
dns-loading-label = Laden...
...
dns-dkim-fallback-description = Algemene DKIM-selectors geprobeerd (bijv. s1, s2, default, k1, google)
...
domains-delete-confirm = Weet u zeker dat u dit domein wilt verwijderen? Deze actie kan niet ongedaan worden gemaakt.
domains-delete-disabled-tooltip = U moet het domein uitschakelen voordat het kan worden verwijderd.
domains-convert-to-backup = Converteren naar back-updomein
domains-convert-to-backup-confirm = Weet u zeker dat u dit domein wilt converteren naar een back-updomein?
domains-convert-error = Kan domein niet converteren
domains-not-found = Domein niet gevonden
domains-not-found-title = Domein niet gevonden
domains-not-found-message = Het domein dat u zoekt kon niet worden gevonden.
...
backups-delete-backup = Back-updomein verwijderen
backups-delete-confirm = Weet u zeker dat u dit back-updomein wilt verwijderen?
backups-delete-disabled-tooltip = U moet het back-updomein uitschakelen voordat het kan worden verwijderd.
backups-convert-to-domain = Converteren naar primair domein
backups-convert-to-domain-confirm = Weet u zeker dat u dit back-updomein wilt converteren naar een primair domein?
backups-convert-error = Kan back-updomein niet converteren
backups-not-found = Back-updomein niet gevonden
backups-not-found-title = Back-updomein niet gevonden
backups-not-found-message = Het back-updomein dat u zoekt kon niet worden gevonden.
...
aliases-delete-disabled-tooltip = U moet de alias uitschakelen voordat deze kan worden verwijderd.
aliases-not-found = Alias niet gevonden
aliases-not-found-title = Alias niet gevonden
aliases-not-found-message = De alias die u zoekt kon niet worden gevonden.
...
users-filter-enabled = Ingeschakeld
users-filter-disabled = Uitgeschakeld
...
users-delete-confirm = Weet u zeker dat u deze gebruiker wilt verwijderen?
users-delete-disabled-tooltip = U moet de gebruiker uitschakelen voordat deze kan worden verwijderd.
users-not-found = Gebruiker niet gevonden
users-not-found-title = Gebruiker niet gevonden
users-not-found-message = De gebruiker die u zoekt kon niet worden gevonden.
...
relays-filter-enabled = Ingeschakeld
relays-filter-disabled = Uitgeschakeld
...
relays-enable = Enable Relay
relays-disable = Disable Relay
relays-update-relay = Update Relay

# Remove Domain Wizard
remove-wizard-title = Domein Verwijderen Wizard
remove-wizard-description = Domein en alle bijbehorende resources permanent verwijderen
remove-wizard-domain-label = Selecteer Domein om te Verwijderen
remove-wizard-domain-placeholder = Kies een domein...
remove-wizard-domain-description = Selecteer het domein dat u permanent uit deze database wilt verwijderen
remove-wizard-warning = Deze wizard zal eerst alle resources uitschakelen en ze vervolgens permanent verwijderen. Deze actie kan niet ongedaan worden gemaakt.
remove-wizard-next = Doorgaan
remove-wizard-cancel = Annuleren
remove-wizard-review-affected-title = Beïnvloede Resources Beoordelen
remove-wizard-review-affected-description = Beoordeel alle resources die zullen worden uitgeschakeld en verwijderd
remove-wizard-affected-resources = Resources die zullen worden beïnvloed
remove-wizard-orphaned-warning = Aliassen die verweest zullen raken
remove-wizard-cross-db-warning = Dit domein bestaat in andere databases
remove-wizard-disable-all = Alle Resources Uitschakelen
remove-wizard-review-disabled-title = Resources Uitgeschakeld
remove-wizard-review-disabled-description = Alle resources zijn uitgeschakeld. U kunt nu doorgaan met verwijderen of annuleren.
remove-wizard-proceed-to-delete = Doorgaan naar Verwijdering
remove-wizard-confirm-delete-title = Verwijdering Bevestigen
remove-wizard-confirm-delete-description = Laatste bevestiging voor permanente verwijdering
remove-wizard-warning-final = ⚠️ WAARSCHUWING: Deze actie kan niet ongedaan worden gemaakt!
remove-wizard-resources-to-delete = Resources die permanent worden verwijderd
remove-wizard-orphaned-reminder = Verweesde aliassen zullen NIET worden verwijderd
remove-wizard-delete-all = VERWIJDER ALLE RESOURCES
remove-wizard-complete-title = Domein Succesvol Verwijderd
remove-wizard-complete-description = Het domein en alle bijbehorende resources zijn permanent verwijderd
remove-wizard-success = Domein succesvol verwijderd
remove-wizard-deleted-resources = Verwijderde Resources
remove-wizard-cross-db-note = Dit domein bestaat nog steeds in andere databases
remove-wizard-back-to-domains = Terug naar Domeinen
remove-wizard-remove-another = Nog een Domein Verwijderen
remove-wizard-resource-domain = Domein
remove-wizard-resource-aliases = Aliassen
remove-wizard-resource-users = Gebruikers
remove-wizard-resource-relays = Relays
remove-wizard-resource-relocated = Verplaatst
...
relays-delete-disabled-tooltip = U moet het relais uitschakelen voordat het kan worden verwijderd.
...
relays-not-found = Relay niet gevonden
relays-not-found-title = Relay niet gevonden
relays-not-found-message = De relay die u zoekt kon niet worden gevonden.
...
relocated-filter-enabled = Ingeschakeld
relocated-filter-disabled = Uitgeschakeld
...
relocated-delete-confirm = Weet u zeker dat u dit verhuisde adres wilt verwijderen?
relocated-delete-disabled-tooltip = U moet het verplaatste adres uitschakelen voordat het kan worden verwijderd.
relocated-not-found = Verplaatst adres niet gevonden
relocated-not-found-title = Verplaatst adres niet gevonden
relocated-not-found-message = Het verplaatste adres dat u zoekt kon niet worden gevonden.
...
clients-filter-enabled = Ingeschakeld
clients-filter-disabled = Uitgeschakeld
...
clients-delete-confirm = Weet u zeker dat u deze klant wilt verwijderen?
clients-delete-disabled-tooltip = U moet de client uitschakelen voordat deze kan worden verwijderd.
clients-not-found = Client niet gevonden
clients-not-found-title = Client niet gevonden
clients-not-found-message = De client die u zoekt kon niet worden gevonden.
...
stats-table-header-users = Gebruikers
stats-table-header-aliases = Aliassen
stats-table-header-relays = Relays
stats-table-header-relocated = Verplaatst
...
cache-stats-report-title = Rapportcaches
cache-stats-report-description = Status van gecachte rapportgegevens
cache-stats-pagination-title = Paginatiecaches
cache-stats-pagination-description = Aantal gecachte paginatie-items
cache-stats-dns-title = DNS-caches
cache-stats-dns-description = Aantal gecachte DNS-items
cached-label = In cache
not-cached-label = Niet in cache
total-entries-label = Totaal aantal items
cache-actions-title = Cachebeheeracties
cache-actions-description = Wis specifieke cachetypen of alle caches om gegevens te vernieuwen
clear-dns-cache = DNS-cache wissen
...
# MX Servers Report
reports-mx-servers-title = MX Servers Rapport
reports-mx-servers-description = Controleer of domein MX-records verwijzen naar geconfigureerde mailservers
reports-mx-status-header = MX Status
reports-mx-records-header = MX Records
reports-missing-servers-header = Ontbrekende Servers
reports-unexpected-servers-header = Onverwachte Servers
reports-mx-status-compliant = Conform
reports-mx-status-non-compliant = Niet Conform
reports-mx-status-empty = Geen MX Records
reports-mx-status-error = DNS Fout
reports-configured-mail-servers = Geconfigureerde Mailservers
reports-summary-title = Samenvatting
reports-total-domains = Totaal Domeinen
reports-compliant-domains = Conform
reports-non-compliant-domains = Niet Conform
reports-empty-mx-domains = Geen MX Records
reports-error-domains = DNS Fouten
reports-filters = Filters
reports-exclude-disabled = Sluit Uitgeschakelde Domeinen Uit
