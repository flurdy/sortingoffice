...
async fn test_alias_creation_workflow() -> Result<()> {
    ...
    run_test_with_timeout(async {
        ...
        assert!(body_text.contains("testalias@testdomain.com"), "Alias should appear in the list after creation");
    ...
    run_test_with_timeout(async {
        ...
        for url in error_urls {
            ...
            assert!(
                ...
                "Error page should show error content for URL: {} (got: {})", url, body_text
            );
        }
