...
@Singleton
class DomainRepository @Inject()(db: Database) {
...
where domain = {name}
   ...
   def findCatchAllDomains(connectionName: ConnectionName, aliasRepository: AliasRepository): List[(Domain,Alias)] = {
      val domains: List[Domain] = db.withConnection { implicit connection =>
         SQL(
            """
...
order by d.domain
   ...
   def findCatchAllRelayDomains(connectionName: ConnectionName, relayRepository: RelayRepository): List[(Domain,Relay)] = {
      val domains: List[Domain] = db.withConnection { implicit connection =>
         SQL(
            """
...
order by d.domain
   ...
   def disable(connectionName: ConnectionName, domain: Domain): Unit = {
      db.withConnection { implicit connection =>
         SQL(
            """
   ...
   def enable(connectionName: ConnectionName, domain: Domain): Unit = {
      db.withConnection { implicit connection =>
         SQL(
            """
   ...
   def disableBackup(connectionName: ConnectionName, backup: Backup): Unit = {
      db.withConnection { implicit connection =>
         SQL(
            """
   ...
   def enableBackup(connectionName: ConnectionName, backup: Backup): Unit = {
      db.withConnection { implicit connection =>
         SQL(
            """
   ...
   def save(connectionName: ConnectionName, domain: Domain): Unit = {
      db.withConnection { implicit connection =>
         SQL(
            """
insert into domains (domain,enabled,transport) values ({name},{enabled},{transport})
   ...
   def saveBackup(connectionName: ConnectionName, backup: Backup): Unit = {
      db.withConnection { implicit connection =>
         SQL(
            """
insert into backups (domain,enabled,transport) values ({name},{enabled},{transport})
   ...
   def delete(connectionName: ConnectionName, domain: Domain): Unit = {
      db.withConnection { implicit connection =>
         SQL(
            """
delete from domains where domain = {name}
   ...
   def deleteBackup(connectionName: ConnectionName, backup: Backup): Unit = {
      db.withConnection { implicit connection =>
         SQL(
            """
delete from backups where domain = {name}
   ...
   def updateBackup(connectionName: ConnectionName, backup: Backup): Unit = {
      db.withConnection { implicit connection =>
         SQL(
            """
