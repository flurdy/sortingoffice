...
async fn main() {
    ...
    let app = Router::new()
        ...
        .route("/domains/:id/toggle-list", post(handlers::domains::toggle_active_list))
        .route("/domains/:id/toggle-show", post(handlers::domains::toggle_active_show))
        .route("/domains/:id/toggle", post(handlers::domains::toggle_active))
        // Users
        ...
        .route("/users/:id/toggle-list", post(handlers::users::toggle_active_list))
        .route("/users/:id/toggle-show", post(handlers::users::toggle_active_show))
