...
pub struct ReportsListTemplate<'a> {
    ...
    pub mx_servers_report_title: &'a str,
    pub mx_servers_report_description: &'a str,
...
pub struct DomainStatisticsReportTemplate<'a> {
    ...
    pub table_header_relays: &'a str,
    pub table_header_relocated: &'a str,
...
#[derive(Template)]
#[template(path = "reports/mx_servers.html", escape = "html")]
pub struct MxServersReportTemplate<'a> {
    pub title: &'a str,
    pub description: &'a str,
    pub domain_header: &'a str,
    pub mx_status_header: &'a str,
    pub mx_records_header: &'a str,
    pub missing_servers_header: &'a str,
    pub unexpected_servers_header: &'a str,
    pub legend_title: &'a str,
    pub status_compliant: &'a str,
    pub status_non_compliant: &'a str,
    pub status_empty: &'a str,
    pub status_error: &'a str,
    pub no_domains: &'a str,
    pub no_domains_description: &'a str,
    pub back_to_reports: &'a str,
    pub configured_mail_servers: &'a str,
    pub summary_title: &'a str,
    pub total_domains: &'a str,
    pub compliant_domains: &'a str,
    pub non_compliant_domains: &'a str,
    pub empty_mx_domains: &'a str,
    pub error_domains: &'a str,
    pub paginated_result: &'a crate::models::PaginatedResult<crate::models::DomainMxStatus>,
    pub mail_servers: &'a [String],
