...
pub struct DomainsListTemplate<'a> {
    ...
    pub backups_pagination: &'a PaginatedResult<Backup>,
    pub backups_page_range: &'a [i64],
    pub backups_max_item: i64,
...
pub struct DomainShowTemplate<'a> {
    ...
    pub analytics_common_aliases_header: &'a str,
    pub analytics_common_aliases_description: &'a str,
    pub action_view: &'a str,
    ...
    pub convert_to_backup: &'a str,
    pub convert_to_backup_confirm: &'a str,
